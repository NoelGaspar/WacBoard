\documentclass[pucformat,spanish]{XPucThesis}
\usepackage{fixltx2e}
...
\degree       {Ingeniero Civil Electricista} 
...
\ogrsmember{Jorge Bayer}

% Subject
\subject{Engineering}

% Date
\date{Septiembre 2016} %FECHA

% Copyright
\copyrightname{Wladimir Araya Caro} %AUTOR
...
%
%Quisiera agradecer a todos aquellos quienes hicieron posible este trabajo. Agradecer en particular a mis amigos y compañeros de universidad 
%Agradecer a todos aquellos miembros de IC-UC con quienes compartí innumerables horas de trabajo y conversación y me ayudaron incondicionalmente.
%Agradecer a todos los miembros de la rama estudiantil de la IEEE de la Pontificia Universidad Católica.
%En particular a Francisco Retamales, Sergio Aguilera, Diego Gomez y muy especialmente a Igancio Passalaqua quienes mucho mas que compañeros son amigos quienes representan un pilar importante.
%Agradecer a mi familia quienes gracias a su amor y apoyo me han permitido llega tan lejos.
%Finalmente quiero agradecer de forma muy especial a las dos personas mas importantes quienes permitieron que todo esto fuera realmente posible. Primero a mi profesor guía Angel Abusleme, gracias por toda esa buena disposición y apoyo, y por sobre todo por su infinita paciencia. Gracias a esta oportunidad que me ha birndando creo que he descubierto lo que realmente quiero ser en la vida. Y la segunda persona es mi madre a quien quiero con mucho amor y sin ella nada de esto sería posible, en ningun momento ha dejado de creer en mi y ha realizado grandes sacrificios para que yo pueda salir adelante.  Por todo muchisimas gracias.
